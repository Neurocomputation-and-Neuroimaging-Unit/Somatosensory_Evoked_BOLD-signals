function B1_Realignment_all_runs(sj_dir, run_files)
...
if ~isempty(fileset)
    ...
    matlabbatch{1}.spatial{1}.realign{1}.estwrite.eoptions.quality = 1; %%% for testing, set this lower, for actual preprocessing, leave it at 1!! -> takes forever
